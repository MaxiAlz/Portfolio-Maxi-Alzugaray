...
import { Star, ShieldCheck, Drum, Sliders } from 'lucide-react';
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-12 items-center">
            <div className="lg:col-span-5 relative">
              <div className="aspect-square rounded-3xl overflow-hidden bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 shadow-xl relative group">
                ...
                <div className="absolute bottom-6 left-6 right-6 p-4 rounded-2xl bg-white/90 dark:bg-zinc-900/90 backdrop-blur border border-zinc-200/80 dark:border-zinc-800 space-y-0.5">
                  ...
                  <p className="text-xs text-primary font-semibold">Baterista de Sesión & Ingeniero de Audio</p>
                </div>
              </div>
            </div>
            ...
            <div className="lg:col-span-7 space-y-5">
              <span className="text-xs font-semibold text-primary tracking-widest uppercase">
                Biografía & Filosofía de Trabajo
              </span>

              <h2 className="text-3xl sm:text-4xl font-bold text-zinc-900 dark:text-white tracking-tight">
                Sonido orgánico, técnica y pasión al servicio de tu música.
              </h2>

              <p className="text-zinc-600 dark:text-zinc-300 text-base leading-relaxed">
                Durante más de 12 años me he dedicado a la grabación y producción de baterías acústicas, captación en estudio/vivo y tratamientos de mezcla para artistas e independientes.
              </p>

              <p className="text-zinc-500 dark:text-zinc-400 text-sm leading-relaxed">
                El espacio de trabajo fue acondicionado específicamente para lograr respuestas acústicas dinámicas y naturales. Cada micrófono, preamplificador y procesador está calibrado para darle presencia y carácter a cada tema.
              </p>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 pt-2">
                <div className="p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 space-y-1">
                  ...
                  <p className="text-xs text-zinc-600 dark:text-zinc-400">Respuesta dinámica real, afinación precisa y ejecución orgánica adaptada a cada género.</p>
                </div>

                <div className="p-4 rounded-2xl bg-white dark:bg-zinc-900 border border-zinc-200/80 dark:border-zinc-800 space-y-1">
                  <span className="text-xs font-semibold text-primary uppercase tracking-wider block flex items-center gap-1.5">
                    <Sliders className="w-4 h-4" /> Procesamiento Híbrido
                  </span>
                  <p className="text-xs text-zinc-600 dark:text-zinc-400">Suma analógica de alta gama combinada con la precisión quirúrgica del entorno digital.</p>
                </div>
              </div>
              ...
              <div className="pt-2 flex flex-wrap gap-3">
                <button
                  onClick={() => onOpenQuote()}
                  className="px-6 py-3 rounded-full bg-primary hover:bg-primary-hover text-zinc-950 font-bold text-xs shadow-md transition-all"
                >
                  Solicitar un servicio
                </button>
                <button
                  onClick={() => navigate('/equipamiento')}
                  className="px-6 py-3 rounded-full bg-white dark:bg-zinc-900 border border-zinc-200 dark:border-zinc-800 text-zinc-900 dark:text-white font-semibold text-xs transition-all hover:bg-zinc-100 dark:hover:bg-zinc-800"
                >
                  Ver Equipamiento
                </button>
              </div>
